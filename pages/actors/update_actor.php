<?php
    ...
    if(isset($_POST['id']) && $_POST['id'] != "" && isset($_POST['name']) && $_POST['name'] != "" && isset($_POST['lastname']) && $_POST['lastname'] != "") {
        ...
        echo ($query_result) ? '<script>window.location="/?page=actors/actors&modal-success=1&action=update&type=actor";</script>' : '<script>window.location="/?page=actors/actors&modal-failed=1&action=update&type=actor";</script>';
    } else {
        echo '<script>window.location="/?page=actors/actors&modal-failed=1&action=update&type=actor";</script>';
    }
