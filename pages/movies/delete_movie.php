...
if(isset($_POST['movie-id']) && $_POST['movie-id'] != "") {
    ...
    $delete_query_pagos = "DELETE FROM pagos WHERE idPeliculaAlquilo IN (SELECT idPelicula FROM alquileres WHERE idPelicula = $idPelicula)";
    ...
    if($query_result_pagos && $query_result_alquileres && $query_result_actoresDePeliculas && $query_result_idiomasDePeliculas && $query_result_categoriasDePeliculas && $query_result_inventario && $query_result_peliculas) {
